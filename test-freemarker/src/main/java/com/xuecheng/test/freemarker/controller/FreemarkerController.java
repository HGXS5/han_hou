...
//        stu2.setBirthday(new Date());
    ...
    public StudentTemplate getmodel(@PathVariable("id") String id) {
        Optional<StudentTemplate> optional = studentRepository.findById(id);
        if (optional.isPresent()){
            StudentTemplate studentTemplate = optional.get();
